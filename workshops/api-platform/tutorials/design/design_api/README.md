...
### Test in the Apiary Console
  ...
  2. The code example should be selected.  Make sure *Mock Server* is selected, and choose the Language of your choice.  
    _You may switch between the different languages to see examples of how to call the API and you may need to click *[Switch to Console]* to be in sync with the instructions._
